...
module.exports = __webpack_require__(/*! D:\Projects\FlexiSourceExam\FlexiSourceExam.UI\src\main.ts */"zUnb");
...
var environment = {
    production: false,
    API_URL: 'http://localhost:15678/api'
};
...
var routes = [
    {
        path: 'exam',
        loadChildren: function () { return __webpack_require__.e(/*! import() | exam-exam-module */ "exam-exam-module").then(__webpack_require__.bind(null, /*! ./exam/exam.module */ "Xoj1")).then(function (m) { return m.ExamModule; }); }
    },
    {
        path: '**',
        redirectTo: 'exam'
